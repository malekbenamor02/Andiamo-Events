-- Step 3: Round Robin Assignment Function
-- This function assigns orders to ambassadors using round-robin logic
...
-- Function to auto-reassign ignored orders
...
-- Create a function to get next ambassador for a ville (for admin preview)
