...
export interface PaymentConfirmedSuccessProps {
  open: boolean;
...
function getCopy(language: "en" | "fr") {
  return language === "en"
    ? {
        ...
        description: "Sent for admin approval. Tickets will follow once approved.",
        close: "Close",
      }
    : {
        title: "Paiement confirmé",
        description: "Envoyé pour approbation. Les billets suivront une fois validé.",
        close: "Fermer",
      };
}
export function PaymentConfirmedSuccess({
  open,
  onOpenChange,
  language,
  customerName,
  amount,
}: PaymentConfirmedSuccessProps) {
      ...
      {open && (
        <motion.div
          ...
          >
            ...
            <div className="mx-auto mb-5 flex h-[4.5rem] w-[4.5rem] items-center justify-center">              <motion.div
            ...
            <motion.h2
              ...
              className="text-lg font-semibold tracking-tight text-foreground"              initial={reducedMotion ? false : { opacity: 0, y: 6 }}
